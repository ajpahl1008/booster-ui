...
Meteor.methods({
    ...
    addServer: function (serverInfo) {
        this.unblock();
        return Meteor.http.call("POST", URL_PREFIX + '/booster-services/update/inventory/addServer', {
            data: serverInfo,
            headers: {
                "content-type": "application/json",
                "Accept": "application/json"
    ...
    addApplication: function (applicationInfo) {
        this.unblock();
        return Meteor.http.call("POST", URL_PREFIX + '/booster-services/update/applications/addApplication', {
